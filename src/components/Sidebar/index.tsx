...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`absolute left-0 top-0 z-9999 flex h-screen w-50 flex-col overflow-y-hidden border-r border-stroke bg-white dark:border-stroke-dark dark:bg-gray-dark lg:static lg:translate-x-0 ${
          sidebarOpen
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 xl:py-10">
          <Link href="/dashboard">
            <Image
              width={176}
              height={32}
              src={"/images/logo/unibit-ecommerce-logo.svg"}
              alt="Logo"
              priority
            ...
            <Image
              width={176}
              height={32}
              src={"/images/logo/unibit-ecommerce-logo-white.svg"}
              alt="Logo"
              priority
